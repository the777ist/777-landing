  ...
  return (
    <div className={styles.pageContentLanding}>
      ...
      <div ref={containerRef} className={`${styles.contentContainerLanding} ${styles.second}`}>
        <div className={`${styles.navText} ${active === "blog" ? styles.navTextActive : ""}`} onClick={() => setActive("blog")}>Blog</div>
        <div className={`${styles.navText} ${active === "events" ? styles.navTextActive : ""}`} onClick={() => setActive("events")}>Events</div>
        <div className={`${styles.navText} ${active === "music" ? styles.navTextActive : ""}`} onClick={() => setActive("music")}>Music</div>
